...
Theta1_grad= ((model.hid_to_class'*(class_prob -data.targets)).*hid_output.*(1-hid_output))*data.inputs'/N + wd_coefficient*model.input_to_hid;

Theta2_grad= ((class_prob - data.targets)*hid_output')/N + wd_coefficient*model.hid_to_class; 
